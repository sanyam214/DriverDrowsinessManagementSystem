...
### Step 1: 
Clone the repository into your system by: directly download the zip.
...
We have used and Android App available for free in Play Store, named IP Webcam. After downloading it, open the app and scroll down to the option <b>Start Server</b>.

After starting the server, an IP will be displayed on the screen. In <b>line 36</b> put the given IP. 
```python
```
